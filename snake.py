...
if(check_errors[1] > 0):
    ...
    print("\t * * Juego exitosamente cargado :D * *")

#Inicando juego en la ventana
pygame.display.set_caption("SNAKE, PERO SIN SOLID")
game_window = pygame.display.set_mode((frame_size_x, frame_size_y),0)

#colores
black = pygame.Color(0, 0, 0)
white = pygame.Color(255, 255, 255)
red = pygame.Color(220, 10, 10)
green = pygame.Color(52, 202, 45)
blue = pygame.Color(45, 123, 202)

fps_controller = pygame.time.Clock()

#Cuadrados para la culebra
...
def show_score(choice, color, font, size):
    ...
    if choice == 1:
        ...
        score_rect.midtop = (frame_size_x / 2, frame_size_y / 12)
...
while True:
    ...
    #Spawn de manzanas pa que harte
    if not food_spawn:
        food_pos = [random.randrange(1, (frame_size_x // square_size)) * square_size,
    ...
    #Pal Valhalla o pal helheim, a casa malo, te dejaron 7 - 0, game over

    for block in snake_body[1:]:
        if head_pos[0] == block[0] and head_pos[1] == block[1]: init_vars()
